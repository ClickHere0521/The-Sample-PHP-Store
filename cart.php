                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Total</th><th>PKR <?php echo $sum;?>/-</th><th><a href="success.php?id=<?php echo $user_id?>" class="btn btn-primary">Confirm Order</a>&nbsp &nbsp &nbsp<a href="products.php" class="btn btn-primary">Back to Store</a></th>
                        </tr>
                    </tbody>
                </table>
            </div>
